...
def mask_image():
    ...
    binary,actual_image = dim_module.imag(filename,image)
    

    
    # Save the binary image
    destination_dir = 'upload'
    #destination_dir = 'C:/Users/hp/Pictures/dimension_measurement/static/images/p'
    ...
    _, img_encoded1 = cv2.imencode('.jpg',actual_image)
    # Convert the input image to Base64 string
    input_data = base64.b64encode(img_encoded1).decode('utf-8')
